function [z]=vad(data,fs, opts, vadThres)

% Usage: vad(finwav, fvad) finwav 变成了data与fs
...
%
% Refs:
%  [1] Z.-H. Tan, A.k. Sarkara and N. Dehak, "rVAD: an unsupervised segment-based robust voice activity detection method," Manuscript submitted for publication. 
%  [2] Z.-H. Tan and B. Lindberg, "Low-complexity variable frame rate analysis for speech recognition and voice activity detection,鈥?IEEE Journal of Selected Topics in Signal Processing, vol. 4, no. 5, pp. 798-807, 2010.
%
